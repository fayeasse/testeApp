package com.groupeisi.sn.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.groupeisi.sn.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.groupeisi.sn.security.DomainUserDetailsService", "createSpringSecurityUser");
