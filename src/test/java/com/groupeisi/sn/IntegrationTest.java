package com.groupeisi.sn;

import com.groupeisi.sn.TesteApp;
import com.groupeisi.sn.config.AsyncSyncConfiguration;
import com.groupeisi.sn.config.EmbeddedSQL;
...
@SpringBootTest(classes = { TesteApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
